        ...
        <el-table :data="tableData" style="width: 100%" border stripe>
          ...
          <el-table-column label="操作" width="220px">
            <template slot-scope="scope">
              ...
              <el-button plain size="small" type="danger" @click="handleRowDelete(scope.$index, scope.row)"
                >删除
              </el-button>
            </template>
          </el-table-column>
    ...
    <el-dialog :title="is_add ? '添加' : '编辑'" :visible.sync="dialog">
      <el-form :model="noticeData">
        ...
        <el-form-item label="到期时间:" label-width="120px">
          <el-date-picker v-model="noticeData.time" type="datetime" placeholder="选择日期时间" default-time="23:59:59">
          </el-date-picker>
        </el-form-item>
      </el-form>
...
export default {
  ...
  methods: {
    ...
    submitContent(index, row) {
      this.axios.post('notice/updateContent', { id: row.id, content: row.content })
    },
